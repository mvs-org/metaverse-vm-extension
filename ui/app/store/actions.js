...
export function updateAndSetCustomRpc (newRpc, chainId, ticker = 'ETP', nickname, rpcPrefs) {
  return async (dispatch) => {
...
export function editRpc (oldRpc, newRpc, chainId, ticker = 'ETP', nickname, rpcPrefs) {
  return async (dispatch) => {
...
export function setRpcTarget (newRpc, chainId, ticker = 'ETP', nickname) {
  return async (dispatch) => {
