...
* @param {string} [options.fromCurrency = 'ETP' | 'USD'] The currency of the passed value
* @param {string} [options.toCurrency = 'ETP' | 'USD'] The desired currency of the result
...
const toNormalizedDenomination = {
  ...
  ETP: (bigNumber) => bigNumber.div(BIG_NUMBER_ETH_MULTIPLIER),
}
const toSpecifiedDenomination = {
  WEI: (bigNumber) => bigNumber.times(BIG_NUMBER_WEI_MULTIPLIER).round(),
  GWEI: (bigNumber) => bigNumber.times(BIG_NUMBER_GWEI_MULTIPLIER).round(9),
  ETH: (bigNumber) => bigNumber.times(BIG_NUMBER_ETH_MULTIPLIER).round(9),
  ETP: (bigNumber) => bigNumber.times(BIG_NUMBER_ETH_MULTIPLIER).round(9),
}
const baseChange = {
  hex: (n) => n.toString(16),
